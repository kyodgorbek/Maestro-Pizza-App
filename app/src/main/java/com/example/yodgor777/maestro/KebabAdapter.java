...
public class KebabAdapter extends SectioningAdapter implements Filterable {
    static String TAG = "Adapter";
    private Context context;
    private ItemsDataHolder listItems[] = null;
    private ItemsDataHolder OriganalListItems[] = null;

    KebabAdapter(Context context, ItemsDataHolder[] listItems) {
    ...
    public ItemViewHolder onCreateItemViewHolder(ViewGroup parent, int itemType) {
        ...
        View v = inflater.inflate(R.layout.kebab_item, null);
    ...
    public HeaderViewHolder onCreateHeaderViewHolder(ViewGroup parent, int headerType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View v = inflater.inflate(R.layout.kebab_header, null);
    ...
    public void onBindItemViewHolder(SectioningAdapter.ItemViewHolder viewHolder, int sectionIndex, int itemIndex, int itemType) {
        ...
        String Price = listItems[sectionIndex].CatItemsHolder[itemIndex].Price;
    ...
    private class ItemViewHolder extends SectioningAdapter.ItemViewHolder {
        TextView ItemName, FlavorName, Price;
