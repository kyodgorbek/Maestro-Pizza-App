...
public class FindUsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Marker DSlocation = mMap.addMarker(new MarkerOptions().position(sydney).title("Maestro restaurang & pizzeria").snippet("Click Navigation icon below for navigation"));
