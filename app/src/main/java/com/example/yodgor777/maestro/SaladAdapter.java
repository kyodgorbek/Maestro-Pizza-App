...
public class SaladAdapter extends SectioningAdapter implements Filterable {
    static String TAG = "Adapter";
    private Context context;
    private ItemsDataHolder listItems[] = null;
    private ItemsDataHolder OriganalListItems[] = null;

    SaladAdapter(Context context, ItemsDataHolder[] listItems) {
    ...
    @Override
    public SaladAdapter.ItemViewHolder onCreateItemViewHolder(ViewGroup parent, int itemType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View v = inflater.inflate(R.layout.salad_item, null);
        Log.d(TAG, "onCreateItemViewHolder: called");
        return new SaladAdapter.ItemViewHolder(v);
    }

    @Override
    public SaladAdapter.HeaderViewHolder onCreateHeaderViewHolder(ViewGroup parent, int headerType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View v = inflater.inflate(R.layout.salad_header, null);
        Log.d(TAG, "onCreateHeaderViewHolder: called");
        return new SaladAdapter.HeaderViewHolder(v);
    }
    ...
    protected class ItemViewHolder extends SectioningAdapter.ItemViewHolder {
